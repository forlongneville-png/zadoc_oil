...
export interface ZadocUser { id: string; name: string; phone: string; language: 'en' | 'fr'; created_at: string; isAdmin: boolean; }
...
export interface Product { id: string; name: string; slug: string; description: string; category: string; benefits: string[]; usage: string; warnings: string; active: boolean; price: number | null; images: { image_url: string; display_order: number }[]; }
